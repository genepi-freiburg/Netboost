...
RcppExport SEXP netboost_filter_base(SEXP dataSEXP, SEXP stepnoSEXP, SEXP mode_SEXP) {
BEGIN_RCPP
...
// filter_end
void filter_end();
RcppExport SEXP netboost_filter_end() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    filter_end();
    return R_NilValue;
...
RcppExport SEXP netboost_rcpp_filter_step(SEXP col_ySEXP) {
BEGIN_RCPP
...
RcppExport SEXP netboost_dist_tom(SEXP filterSEXP, SEXP adjacencySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP netboost_tree_search(SEXP netboost_forestSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
