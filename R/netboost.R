...
#'  filter <- nb_filter(datan=datan, stepno=stepno, until=0L, progress=1000L, cores=cores,mode=2L)
#'  softPower <- 3L
#'  dist <- nb_dist(datan=datan, filter=filter, softPower=softPower, cores=cores)
...
#' @param scale     Logical. Should data be scaled and centered?
#' @param onlyModuleMembership     Logical. Should only module memberships be transfered and PCs be newly computed?
#' @return List
#' @export
